...
public class OpenSimplexNoise {
	...
	public double noise2D(double x, double y, int noiseoffset) {
		
		x = x/(double)noiseoffset;
		y = y/(double)noiseoffset;
	...
	public double noise3D(double x, double y, double z, float noiseoffset) {
		
		x = x / (double) noiseoffset;
		y = y / (double) noiseoffset;
		z = z / (double) noiseoffset;
